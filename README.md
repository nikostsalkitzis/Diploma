...
>     --num_patients 3 \
>     --window_size 48 \
>     --save_path track2_lstmcnn_128_32_4 \
...
>     --features_path data/track2_features/ \
>     --dataset_path data/track2/ \
>     --submission_path submissions_lstmcnn_128_32_4 \
>     --load_path track2_lstmcnn_128_32_4/best_model.pth \
>     --scaler_path track2_lstmcnn_128_32_4/scaler.pkl \
>     --input_features 8 \
>     --cnn_channels 128 \
>     --lstm_hidden 32 \
>     --lstm_layers 4 \
